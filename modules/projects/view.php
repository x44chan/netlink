<?php
	...
	$projects = "SELECT * FROM projects where projects_id = '$id' ORDER BY date DESC";
...
<div class="container">
    ...
    <div class="row">
		<div class="col-xs-8" align="left">
			<h4 style="font-size: 15px;"><u><b><span class="icon-stack"></span> <?php echo $res->title; ?> </b></u></h4>
		</div>		
		<div class="col-xs-4">
			<a href = "javascript:javascript:history.go(-1)" class="btn btn-danger btn-sm pull-right" style = "margin-top: 2px;" data-toggle="tooltip" title="Back"><span class = " icon-arrow-left"></span></a>
		</div>
	</div>
    <div class="row">
    	<div class="col-xs-12" align="center">
    		<hr>
    		<?php echo $res->caption;?>
    		<hr>
    	</div>
    </div>
    <?php
		$photos = "SELECT * FROM photos where project_id = '$id' ORDER BY photo_id ASC";
