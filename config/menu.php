    ...
    <nav id = "mainNav" class="navbar navbar-custom navbar-fixed-top navbar-custom affix-top">
      <div class="container-fluid" style="margin: 0px 35px 0px 35px;">
        ...
        <div id="navbar" class="navbar-collapse collapse">
        	<ul class="nav navbar-nav navbar-left">
        	    ...
        	    <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="icon-stack"></span> Projects <b class="caret"></b></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a role = "button" href = "project/completed"><span class="icon-checkmark"></span> Completed Projects </a></li>
                        <li><a role = "button" href = "project/ongoing"><span class="icon-hour-glass"></span> Ongoing Projects </a></li>
                    </ul>
                </li>
